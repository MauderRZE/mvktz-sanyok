@props(['id' => null, 'editAction' => null, 'deleteAction' => null])
...
<div class="flex items-center justify-end gap-1">
    ...
    @endif
    @if($delete)
    <button wire:click="{{ $delete }}" class="p-2 rounded-lg text-gray-500 hover:text-red-400 hover:bg-red-500/10 transition-colors" title="Видалити">
