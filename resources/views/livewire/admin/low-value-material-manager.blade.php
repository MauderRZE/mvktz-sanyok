<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <p class="text-sm text-gray-500">Всього позицій: <span class="text-gray-300 font-medium">{{ count($materials) }}</span></p>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative w-full max-w-lg bg-surface-800 border border-white/5 rounded-2xl shadow-2xl fade-in overflow-hidden">
            <div class="px-6 py-4 border-b border-white/5 flex items-center justify-between">
                <h3 class="text-lg font-semibold text-white">{{ $materialId ? 'Редагувати' : 'Додати' }} МШП</h3>
        ...
        <table class="w-full">
            <thead>
                <tr class="border-b border-white/5">
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Матеріал (МШП)</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Серійний</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">К-сть</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Встановлено на</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Договір</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Дати</th>
            ...
            <tbody class="divide-y divide-white/5 text-sm">
                ...
                <tr class="hover:bg-white/[0.02] transition-colors">
                    ...
                    <td class="px-4 py-3 text-gray-400 font-mono text-xs">{{ $m->serial_number ?? '-' }}</td>
                    <td class="px-4 py-3 text-gray-300 font-semibold">{{ $m->quantity }} шт.</td>
