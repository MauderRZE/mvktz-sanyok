<div class="space-y-6">
    <x-flash />
<x-toolbar :count="count($materials)" label="Всього" buttonLabel="Додати" />

    @if($isOpen)
    <x-modal title="{{ $materialId ? 'Редагувати' : 'Додати' }} матеріал" maxWidth="md">
