...
<x-ui.page-wrapper>
    <x-ui.flash />
    <x-ui.toolbar :count="$dictAttributes->total()" label="Всього атрибутів" buttonLabel="Додати атрибут" />

    {{-- Filters Bar --}}
    <x-ui.card class="p-4 mb-4">
        <div class="flex gap-2">
            <div class="flex-1">
                <x-form.search wire:model.live.debounce.300ms="search" placeholder="Пошук за назвою характеристики..." />
            </div>
            @if($search !== '')
