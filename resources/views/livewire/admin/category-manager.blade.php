<div class="space-y-6">
    <x-flash />
<x-toolbar :count="count($categories)" label="Всього" buttonLabel="Додати" />

    @if($isOpen)
    <x-modal title="{{ $categoryId ? 'Редагувати' : 'Додати' }} категорію" maxWidth="md">
