<div class="space-y-6">
    <x-flash />
<x-toolbar :count="count($components)" label="Всього" buttonLabel="Додати" />

    @if($isOpen)
    <x-modal title="{{ $componentId ? 'Редагувати' : 'Додати' }} компонент" maxWidth="md">
