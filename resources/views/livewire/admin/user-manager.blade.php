<div class="space-y-6">
    <x-flash />
<x-toolbar :count="count($users)" label="Всього" buttonLabel="Додати" />

    @if($isOpen)
    <x-modal title="{{ $userId ? 'Редагувати' : 'Додати' }} адміністратора" maxWidth="lg">
            <div>
