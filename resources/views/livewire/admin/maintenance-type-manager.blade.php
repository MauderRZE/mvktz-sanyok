<div class="space-y-6">
    <x-flash />
<x-toolbar :count="count($types)" label="Всього" buttonLabel="Додати" />

    @if($isOpen)
    <x-modal title="{{ $typeId ? 'Редагувати' : 'Додати' }} тип обслуговування" maxWidth="md">
