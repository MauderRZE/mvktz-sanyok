...
<x-ui.page-wrapper>
    <x-ui.flash />
    <x-ui.toolbar :count="$departments->total()" label="Всього відділів" buttonLabel="Додати відділ" />

    {{-- Filters Bar --}}
    <x-ui.card class="p-4 mb-4">
        <div class="flex gap-2">
            <div class="flex-1">
                <x-form.search wire:model.live.debounce.300ms="search" placeholder="Пошук за назвою відділу..." />
            </div>
            @if($search !== '')
